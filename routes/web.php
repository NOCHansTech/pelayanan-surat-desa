...
Route::middleware(['auth:web'])->group(function () {
    ...
    Route::post('/resident/{id}/update', [ResidentController::class, 'update'])->name('resident.update.post');

    // Resident Delete - HANYA ADMIN
    // Route::middleware(['admin'])->group(function () {
    Route::delete('/resident/{id}', [ResidentController::class, 'destroy'])->name('resident.destroy');
    Route::post('/resident/{id}/delete', [ResidentController::class, 'destroy'])->name('resident.delete');
    // });
});
